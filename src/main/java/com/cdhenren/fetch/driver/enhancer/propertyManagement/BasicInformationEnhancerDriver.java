 ...
 * @version 3.0.0
 */
public class BasicInformationEnhancerDriver extends AbstractDriverEnhancerTemplate {
    public BasicInformationEnhancerDriver(TaskWrap taskWrap, Semaphore semaphore) {
    ...
    protected void setup() throws Exception {
        chromeWait(driver, 3);
        //基础信息
        WebElement element = driver.findElement(By.cssSelector("#customMenu > ul > li:nth-child(2)"));
        ...
        for (WebElement menu : menus) {
            ...
            logger.info("{}", text);
            if (menu.getText().contains("物业信息管理")) {
                menu.click();
                break;
            }
        }
        ...
        dealDownLoadFile(resultSets, 1, TmpBasicInformation.class, "物业信息");
    }
}
