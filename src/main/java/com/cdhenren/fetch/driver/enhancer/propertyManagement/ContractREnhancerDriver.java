 ...
 * @date 2019.11.03
 */
public class ContractREnhancerDriver extends AbstractDriverEnhancerTemplate {
    public ContractREnhancerDriver(TaskWrap taskWrap, Semaphore semaphore) {
    ...
    protected void setup() throws Exception {
        ...
        for (WebElement menu : menus) {
            ...
            logger.info("{}", text);
            if (menu.getText().contains("合同信息管理")) {
                menu.click();
                break;
            }
        }
        ...
        dealDownLoadFile(resultSets, 2, TmpPropertyContract.class, "合同信息");
    }
}
