 ...
 */
public class EleFee3EnhancerDriver extends AbstractDriverEnhancerTemplate {
    public EleFee3EnhancerDriver(TaskWrap taskWrap, Semaphore semaphore) {
    ...
    protected void setup() throws Exception {
        ...
        for (WebElement menu : menus) {
            ...
            if (menu.getText().contains("预付费核销台账")) {
                menu.click();
                break;
            }
        }
        ...
        driver.get(src);
        TimeUnit.SECONDS.sleep(2);
        driver.findElement(By.cssSelector("#cityOrgCode")).click();
        ...
        for (int i = 2; i < itemLen; i++) {
            ...
            driver.findElement(By.cssSelector("#cityOrgCode > span > span")).click();
            items = driver.findElements(By.cssSelector("#mini-6 > div.mini-listbox-border > div.mini-listbox-view > div > table >tbody> tr"));
        }
        TimeUnit.SECONDS.sleep(5);
        dealDownLoadFile(resultSets, 2, TmpEleFee3.class, "预付电费明细台账");
    }
}
